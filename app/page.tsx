    ...
    <main>
      <section className="grid-bg relative overflow-hidden border-b border-white/8">
        ...
        <div className="mx-auto max-w-7xl px-5 pb-24 pt-20 lg:px-8 lg:pb-28 lg:pt-28">
          ...
          <div className="mt-16 grid max-w-3xl gap-3 sm:grid-cols-3"><Stat n="2025" t="final-phase data"/><Stat n="11" t="categories"/><Stat n="22" t="gender/category cutoffs"/></div>
        </div>
